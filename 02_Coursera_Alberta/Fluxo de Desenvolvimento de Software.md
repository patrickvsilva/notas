...
```mermaid
flowchart TD
    A["1. [[Levantamento de Requisitos]]<br>(Perguntas & Investigação)"] --> B["2. [[Design Conceitual]]<br>(Mockups, Componentes, Responsabilidades)"]
    B --> C["3. [[Design Técnico]]<br>(Diagramas UML, Classes, APIs)"]
    C --> D["4. Implementação<br>(Código & Testes)"]
```
